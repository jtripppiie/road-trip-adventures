...
(function () {
  ...
  const vehicleAndPlateItems = [
    ...
    {
      id: 'vehicle-with-visible-rust',
      emoji: '🧲',
      label: 'Visible rust',
      hint: 'Rusty bumper, wheel well, door, trailer, or work truck panel.',
    },
    {
  ...
  const landmarkAndOddityItems = [
    ...
    {
      id: 'something-with-bright-stripes',
      emoji: '〰️',
      label: 'Bright stripes',
      hint: 'Painted stripes, warning stripes, racing stripes, awning, or striped sign.',
    },
    {
      id: 'something-with-three-shapes',
      emoji: '🔺',
      label: 'Three shapes together',
      hint: 'A sign, logo, building, or mural showing three different shapes.',
    },
    {
  ...
  window.RTA_CHAOS_CHALLENGES = [
    ...
    'First player to point out something shiny and something handmade-looking wins. The group verifies both.',
