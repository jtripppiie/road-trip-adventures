...
(function () {
  ...
  // Extra Balanced Pack
  const extraBalancedItems = [
    {
      id: 'roof-rack-empty',
      emoji: '🧳',
      label: 'Empty roof rack',
      hint: 'A rack with nothing on it. The mystery is what used to be there.',
      themes: ['vehicles', 'easy'],
    },
    {
      id: 'pickup-with-toolbox',
      emoji: '🧰',
      label: 'Truck toolbox',
      hint: 'Metal toolbox in a pickup bed, work truck, trailer, or utility rig.',
      themes: ['vehicles', 'easy'],
    },
    {
      id: 'vehicle-with-temp-tag',
      emoji: '🧾',
      label: 'Temporary tag',
      hint: 'Paper tag, dealer plate, temporary permit, or new-car window paper.',
      themes: ['vehicles', 'signs'],
    },
    {
      id: 'camper-with-map-decal',
      emoji: '🗺️',
      label: 'Map decal on camper',
      hint: 'State map, route map, mountain map, or travel stickers on an RV.',
      themes: ['vehicles', 'jackpot'],
    },
    {
      id: 'trailer-with-two-axles',
      emoji: '🛞',
      label: 'Two-axle trailer',
      hint: 'A trailer with two wheel sets on the same side.',
      themes: ['vehicles'],
    },
    {
      id: 'vehicle-with-snowplow-mount',
      emoji: '❄️',
      label: 'Snowplow mount',
      hint: 'Front plow blade, plow brackets, salt truck, or snow-removal rig.',
      themes: ['vehicles', 'alaska-train'],
    },
    {
      id: 'business-van-with-ladder-rack',
      emoji: '🪜',
      label: 'Ladder-rack van',
      hint: 'Work van or truck with ladder racks, even if the ladders are missing.',
      themes: ['vehicles', 'places', 'easy'],
    },
    {
      id: 'vehicle-with-state-sticker-map',
      emoji: '📍',
      label: 'State sticker map',
      hint: 'RV, camper, or car sticker map showing places visited.',
      themes: ['vehicles', 'jackpot'],
    },
    {
      id: 'sign-with-hours',
      emoji: '🕘',
      label: 'Hours on a sign',
      hint: 'Open hours on a storefront, attraction, park, office, or roadside sign.',
      themes: ['signs', 'places', 'easy'],
    },
    {
      id: 'sign-with-handwritten-message',
      emoji: '✍️',
      label: 'Handwritten sign',
      hint: 'Marker board, cardboard, chalkboard, yard sign, or window note.',
      themes: ['signs', 'weird'],
    },
    {
      id: 'sign-with-local-map',
      emoji: '🧭',
      label: 'Map on a sign',
      hint: 'Park map, trail map, campus map, town map, or attraction map.',
      themes: ['signs', 'places'],
    },
    {
      id: 'billboard-with-food-photo',
      emoji: '🍟',
      label: 'Food photo billboard',
      hint: 'Any billboard with a giant meal, snack, drink, or dessert photo.',
      themes: ['signs', 'places', 'easy'],
    },
    {
      id: 'sign-with-mascot-name',
      emoji: '🎭',
      label: 'Named mascot sign',
      hint: 'A mascot, character, or logo with a visible name.',
      themes: ['signs', 'weird', 'places'],
    },
    {
      id: 'historical-marker',
      emoji: '📜',
      label: 'Historical marker',
      hint: 'Plaque, roadside marker, battlefield sign, heritage sign, or old-site sign.',
      themes: ['signs', 'places'],
    },
    {
      id: 'road-sign-with-light',
      emoji: '💡',
      label: 'Lighted road sign',
      hint: 'Blinking sign, school-zone light, warning beacon, or illuminated sign.',
      themes: ['signs', 'easy'],
    },
    {
      id: 'town-population-sign',
      emoji: '👥',
      label: 'Population sign',
      hint: 'Town, city, village, or census-style sign with a population number.',
      themes: ['signs', 'places'],
    },
    {
      id: 'roadside-bench',
      emoji: '🪑',
      label: 'Roadside bench',
      hint: 'Bus stop, park, storefront, trail, memorial, or scenic bench.',
      themes: ['places', 'easy'],
    },
    {
      id: 'bus-stop-shelter',
      ...
      hint: 'Bench, covered stop, route sign, transit map, or bus stop marker.',
      themes: ['places', 'signs', 'easy'],
    },
    {
      id: 'tiny-free-library',
      emoji: '📚',
      label: 'Tiny free library',
      hint: 'Little book box in a yard, park, school, business, or sidewalk.',
      themes: ['places', 'weird'],
    },
    {
      id: 'self-storage-facility',
      emoji: '📦',
      label: 'Self-storage place',
      hint: 'Rows of storage doors, storage sign, moving boxes, or rental units.',
      themes: ['places', 'easy'],
    },
    {
      id: 'veterans-memorial',
      emoji: '🎖️',
      label: 'Veterans memorial',
      hint: 'Monument, plaque, flag display, park sign, or memorial wall.',
      themes: ['places', 'signs'],
    },
    {
      id: 'farm-silo',
      emoji: '🌾',
      label: 'Farm silo',
      hint: 'Tall grain silo, feed bin, barn silo, or farm-storage tower.',
      themes: ['places', 'nature', 'easy'],
    },
    {
      id: 'town-square-gazebo',
      emoji: '🎼',
      label: 'Gazebo or bandstand',
      hint: 'Park gazebo, town square stage, pavilion, or picnic shelter.',
      themes: ['places'],
    },
    {
      id: 'motel-vacancy-sign',
      emoji: '🏨',
      label: 'Vacancy sign',
      hint: 'Motel, hotel, inn, cabin, campground, or lodge vacancy sign.',
      themes: ['places', 'signs'],
    },
    {
      id: 'rain-gutter-waterfall',
      emoji: '💧',
      label: 'Water pouring down',
      hint: 'Gutter, fountain, drain, waterfall, car wash, or rain runoff.',
      themes: ['nature', 'places'],
    },
    {
      id: 'tree-with-bird-nest',
      emoji: '🪺',
      label: 'Nest in a tree',
      hint: 'Bird nest, platform nest, birdhouse in a tree, or nesting sign.',
      themes: ['nature'],
    },
    {
      id: 'field-with-grazing-animals',
      emoji: '🐄',
      label: 'Grazing animals',
      hint: 'Cows, horses, sheep, goats, alpacas, or other animals in a field.',
      themes: ['nature', 'easy'],
    },
    {
      id: 'standing-water-after-rain',
      emoji: '🌧️',
      label: 'Standing water',
      hint: 'Puddle, ditch water, flooded field, wet parking lot, or roadside pool.',
      themes: ['nature', 'easy'],
    },
    {
      id: 'tree-with-red-leaves',
      emoji: '🍁',
      label: 'Red leaves',
      hint: 'A red-leaf tree, shrub, vine, fall color, or landscaping plant.',
      themes: ['nature'],
    },
    {
      id: 'rock-painted-with-message',
      emoji: '🪨',
      label: 'Painted rock',
      hint: 'Rock with words, colors, address numbers, welcome message, or art.',
      themes: ['nature', 'weird'],
    },
    {
      id: 'mountain-view-pullout',
      emoji: '🏔️',
      label: 'Mountain view pullout',
      hint: 'Scenic stop, overlook, turnout, trailhead, or sign for a mountain view.',
      themes: ['nature', 'alaska-train', 'signs'],
    },
    {
      id: 'snow-on-roof',
      emoji: '❄️',
      label: 'Snow on a roof',
      hint: 'Real snow, fake snow display, mountain lodge photo, or winter sign.',
      themes: ['nature', 'alaska-train'],
    },
    {
      id: 'train-themed-restaurant',
      emoji: '🚂',
      label: 'Train-themed restaurant',
      hint: 'Railroad name, train decor, caboose dining, or train picture on a sign.',
      themes: ['alaska-train', 'places', 'signs'],
    },
    {
      id: 'railroad-crossing-number',
      emoji: '#️⃣',
      label: 'Numbered rail crossing',
      hint: 'Crossing ID plate, milepost, track number, or rail warning number.',
      themes: ['alaska-train', 'signs'],
    },
    {
      id: 'train-window-reflection',
      emoji: '🪟',
      label: 'Window reflection',
      hint: 'Reflection in a train, bus, storefront, car window, or station glass.',
      themes: ['alaska-train', 'places'],
    },
    {
      id: 'lodge-with-animal-name',
      emoji: '🏕️',
      label: 'Animal-name lodge',
      hint: 'Lodge, inn, cabin, cafe, or campground named after an animal.',
      themes: ['alaska-train', 'places', 'nature'],
    },
    {
      id: 'weird-mailbox',
      emoji: '📬',
      label: 'Weird mailbox',
      hint: 'Painted, shaped, oversized, themed, decorated, or homemade mailbox.',
      themes: ['weird', 'places', 'jackpot'],
    },
    {
      id: 'yard-with-metal-art',
      emoji: '🔩',
      label: 'Metal yard art',
      hint: 'Sculpture, welded animal, old tools, wind spinner, or scrap art.',
      themes: ['weird', 'places', 'jackpot'],
    },
    {
      id: 'giant-inflatable',
      emoji: '🎈',
      label: 'Giant inflatable',
      hint: 'Tube dancer, holiday inflatable, sale mascot, bounce house, or balloon.',
      themes: ['weird', 'jackpot', 'places'],
    },
    {
      id: 'mystery-covered-object',
      emoji: '❔',
      label: 'Covered mystery object',
      hint: 'Tarped car, wrapped statue, covered load, or something hidden outside.',
      themes: ['weird', 'vehicles'],
    },
    {
      id: 'building-painted-bright-color',
      emoji: '🎨',
      label: 'Bright building',
      hint: 'Pink, purple, turquoise, lime, orange, or another loud building color.',
      themes: ['weird', 'places', 'jackpot'],
    },
    {
      id: 'roadside-photo-op-frame',
      emoji: '📸',
      label: 'Photo-op frame',
      hint: 'Big picture frame, wings mural, cutout board, or selfie spot.',
      themes: ['weird', 'places', 'jackpot'],
    },
    {
      id: 'sign-shaped-like-object',
      emoji: '🪧',
      label: 'Object-shaped sign',
      hint: 'Sign shaped like food, tool, animal, vehicle, bottle, boot, or hat.',
      themes: ['weird', 'signs', 'jackpot'],
    },
    {
      id: 'tiny-door-or-window',
      emoji: '🚪',
      label: 'Tiny door or window',
