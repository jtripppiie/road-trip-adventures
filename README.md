...
- **Hide & Seek Adventure:** Play a local pass-and-play canvas game with a 1-minute hiding scramble, 2-minute default search timer, real hiding spot states, listen clues, cover quality, obstacles, room transitions and role swaps.
